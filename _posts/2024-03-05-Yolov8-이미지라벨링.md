...
![docs](/assets/images/Yolov8-1.1.png)<br>
![docs](/assets/images/Yolov8-1.2.png)<br>

### 3. 라벨링 실행
Open Dir -> 학습할 이미지가 있는 폴더<br>
![docs](/assets/images/Yolov8-1.3.png)
![docs](/assets/images/Yolov8-1.4.png)

A : 이전이미지<br>
D : 다음이미지

### 4. 라벨링 결과 확인
![docs](/assets/images/Yolov8-1.5.png)<br>
json과 함께 같이 저장됨<br>
...
![docs](/assets/images/Yolov8-1.6.png)<br>
