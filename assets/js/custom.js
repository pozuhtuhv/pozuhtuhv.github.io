  ...
  if (window.location.pathname.includes('/portfolio/')) {
    var projectsData = {
      project1: {
        ...
        tags: ["Python", "Selenium", "BeautifulSoup", "MySQL", "SpreadSheet", "Analytics", "TagMnanager", "API", "ROI 개선", "데이터 정확성"],
      ...
      project2: {
        ...
        tags: ["Python", "MySQL", "Looker Studio", "Streamlit", "Tableau", "KPI 추적", "성과 시각화", "채널 분석"],
      ...
      project3: {
        ...
        tags: ["Python", "MySQL", "Slack API", "실시간 인사이트", "트렌드 알림", "데이터 결합"],
        role: "시스템 기획 및 개발",
      ...
      project4: {
        ...
        tags: ["Python", "Tkinter", "BeautifulSoup", "API", "키워드", "검색 가시성", "경쟁력 분석", "전략"],
        role: "프로그램 기획 및 개발",
